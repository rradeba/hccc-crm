...
const PricingTool = ({
  ...
  useEffect(() => {
    ...
    if (Object.keys(openPricingStructureDropdown || {}).length > 0 || openPricingDropdown !== null || openPackageFormulaDropdown !== null || openPercentDropdown !== null) {
      document.addEventListener('mousedown', handleClickOutside);
      return () => {
        document.removeEventListener('mousedown', handleClickOutside);
      };
    }
  }, [openPricingStructureDropdown, setOpenPricingStructureDropdown, openPricingDropdown, setOpenPricingDropdown, openPackageFormulaDropdown, openPercentDropdown]);
                ...
                {pricingFormats.map((format) => (
                    ...
                    >
                      {/* Service Header with Plus Button */}
                        ...
                        {/* Dropdown Caret for Pricing Inputs - Far Right */}
                        <button
                          type="button"
                          onClick={() => {
                            setPricingFormats((prev) =>
                            ...
                            {['rates', 'expenses', 'fees', 'multipliers'].map((sectionType, sectionIndex) => {
                              ...
                              return (
                                <React.Fragment key={sectionType}>
                                  ...
                                  <div className="relative flex-1 min-w-0 border-2 border-gray-300 rounded-2xl px-4 py-3 bg-slate-50/60 shadow-md flex flex-col" style={{ minHeight: '280px' }}>
                                    {/* Section Label */}
                                            ...
                                            <div className="border-t border-gray-200 mt-2 pt-2 px-2">
                                              <div className="flex items-center gap-2">
                                                <input
                                                  ...
                                                  className="flex-1 max-w-[140px] px-2 py-1.5 border border-gray-300 rounded text-xs"
                                                  onClick={(e) => e.stopPropagation()}
                                                />
                                                <button
                                                  type="button"
                                        ...
                                        <div className="space-y-1.5">
                                          {selectedItems.map((item, index) => {
                                            ...
                                            return (
                                              <div
                                                key={itemKey}
                                                className="flex flex-col gap-2 px-3 py-2 rounded-lg text-xs font-medium bg-blue-50 text-blue-700 border border-slate-200 hover:shadow-md transition-shadow min-w-0 w-full overflow-hidden selected-item-row"
                                                    ...
                                                    <>
                                                      <div className="flex items-center gap-1 w-full">
                                                        ...
                                                        <input
                                                          ...
                                                          className="flex-1 min-w-0 px-2 py-1 border border-gray-300 rounded-md text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 bg-white"
                                                          placeholder="0.00"
                                                          style={{ maxWidth: '100%', width: '100%', boxSizing: 'border-box' }}
                                                        />
                                                      </div>
                      ...
                      {/* Divider Line - Only show when sections are expanded */}
                      {!format.isPricingPanelsCollapsed && (
                        <div className="pricing-formula-divider"></div>
                      )}
              ...
              <div className="flex justify-end items-center mt-6 pt-6 border-t border-slate-200">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    aria-label="Add Item"
                  >
                    <span className="text-xl font-bold leading-none flex items-center justify-center" style={{ lineHeight: '1' }}>+</span>
                  </button>
                  <button
                    onClick={() => {
            ...
            <div>
              ...
              <div className="space-y-3">
                {promotions.map((promotion) => {
                  ...
                  const isBlank = !promotion.title && !promotion.promotionType && !promotion.startDate && !promotion.endDate && 
                  ...
                  >
                    {/* Delete Button - Only show if promotion has data */}
                    {!isBlank && (
                      <button
                        type="button"
                        onClick={() =>
                    ...
                    {/* First Row - Promotion Title and Type */}
                            ...
                            <div className="flex gap-8 items-start">
                              ...
                              <div className="flex flex-col items-start gap-3 flex-1">
                                <div className="flex items-center justify-between w-full">
                                  ...
                                  <div className="relative" data-promotion-dropdown>
                                    {openPackageFormulaDropdown === `${promotion.id}-percent-service` && (
                                      <div className="absolute z-50 mt-1 right-0 w-64 bg-white border border-gray-300 rounded-xl shadow-lg max-h-96 overflow-y-auto" data-promotion-dropdown>
                                        <div className="p-2 space-y-1">
                                ...
                                <div className="flex flex-col gap-2 w-full">
                                  {(promotion.percentOffServices || []).length === 0 && (
                                    <button
                                      ...
                                      className="text-sm text-gray-600 py-2 px-4 bg-gray-50 rounded-lg border border-gray-300 hover:bg-gray-100 transition-colors text-left"
                                ...
                                <div className="flex flex-col items-start gap-3 flex-1">
                                  ...
                                  <div className="relative pricing-structure-dropdown-container w-full" data-promotion-dropdown>
                                    ...
                                    {openPackageFormulaDropdown === `${promotion.id}-package-services` && (
                                      <div className="absolute z-[100] w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-64 overflow-y-auto pricing-structure-dropdown-container" data-promotion-dropdown>
                                        <div className="p-2 space-y-1">
              ...
              {/* Add Item Button and Save Button */}
              <div className="flex justify-end items-center mt-6 pt-6 border-t border-slate-200">
                <div className="flex items-center gap-3">
                  <button
                    type="button"
